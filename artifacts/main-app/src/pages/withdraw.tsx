      ...
      >
        <div className="w-full max-w-md">
          ...
          {(profile?.walletBalance ?? 0) < MIN_WITHDRAWAL && (
            ...
            >
              ...
              <Link
                ...
                style={{ background: "linear-gradient(135deg,#FFD700,#D4AF37)", color: "hsl(78,90%,10%)" }}
              >
          ...
          <div
            ...
            style={{ background: "hsl(78,80%,14%)", border: "1px solid hsl(43,30%,24%,0.5)" }}
          >
            <button
              type="button"
              ...
              style={
                method === "telebirr"
                  ? { background: "linear-gradient(135deg,#FFD700,#D4AF37)", color: "hsl(78,90%,10%)" }
                  : { color: SOFT }
              }
            >
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              >
                                <option value="" disabled style={{ background: "hsl(78,80%,14%)" }}>
                                  {t("wd_bank_select_placeholder")}
                                </option>
                                {ETHIOPIAN_BANKS.map((bank) => (
                                  <option key={bank} value={bank} style={{ background: "hsl(78,80%,14%)" }}>
                                    {bank}
                                  </option>
                                ))}
                              </select>
